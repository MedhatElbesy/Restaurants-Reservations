  ...
  const onSubmit = async (data) => {
    ...
    if (!data.roles_name) {
      Swal.fire({
        icon: "error",
        title: "Oops...",
        text: "Please select if you want to register as a user or an admin.",
      });
      setError("Please select if you want to register as a user or an admin.");
      return;
    }
